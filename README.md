...
Streak out the standard yeast strain [in Joglekar lab, we use AJY939 (*MAT*a, *NDC80-GFP:KAN, SPC25-mCherry:KAN*)] on a yeast extract-peptone-dextrose (YPD) agar plate. One day ahead of imaging, innoculate colonies into 2 mL of YPD media in the afternoon and shake at 30 °C overnight. On the day of imaging, innoculate 4 mL of fresh YPD media **in a 125-mL flask** (for better ventilation) with the overnight culture (1:10 dilution). Shake at 30 °C for 3 h. Take 500 μL of the log-phase culture, centrifuge at 6,000 g for 1 min, and then remove the supernatant. Resuspend the yeast pellet with 1 mL of synthetic defined (SD) media. Centrifuge at 6,000 g for 1 min again, remove the supernatant, and resuspend the cell with 40 μL of SD media. Apply 6 uL onto a coverslip and then press a microscope slide onto the coverslip. Proceed to image **metaphase cells** before media dry out.
# Acknowledgement
